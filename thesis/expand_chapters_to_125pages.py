...
print("Writing 120+ Page Chapter Generation Script...")

def save_chapter(filename, text):
...
save_chapter("literature_review.tex", ch2)
save_chapter("data_and_features.tex", ch3)
save_chapter("methodology.tex", ch4)
save_chapter("baseline_results.tex", ch5)
save_chapter("ml_and_backtesting.tex", ch6)
save_chapter("conclusion.tex", ch7)

print("Generated all 7 thesis chapters successfully.")
