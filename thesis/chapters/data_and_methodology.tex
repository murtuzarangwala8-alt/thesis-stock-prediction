...
To maintain uniform scaling and stationarity, all raw characteristic variables are converted each day into \textbf{Cross-Sectional Ranks} mapped to the unit interval $[0, 1]$ \citep{freyberger2020dissecting, gu2020empirical}:
\begin{equation}
