...
\begin{enumerate}
    ...
    \item \textbf{Non-Linearity and Feature Interactions}: Factor interactions (such as momentum conditional on volatility or valuation conditional on market regime) are nonlinear and difficult to specify \textit{a priori} using traditional linear equations.
