...
\begin{enumerate}
    \item \textbf{Non-Linear Model Performance}: Nonlinear models (GBDT, Neural Networks) outperform linear models in out-of-sample predictive $R_{\text{oos}}^2$, doubling the annualized Sharpe ratios of long-short hedge portfolios.
    \item \textbf{Importance of Interaction Terms}: A main source of machine learning gain comes from automatically capturing nonlinear characteristic interactions (such as the interaction of size with short term momentum and liquidity).
