...
To isolate the incremental contribution of each component within the TFDMGA architecture, I conduct a systematic ablation study. Table \ref{tab:ch6_ablation_study} reports the out-of-sample predictive metrics across model variants evaluated on the 21-day holding horizon.
...
To evaluate signal stability, Table \ref{tab:ch6_horizon_sensitivity} presents performance across alternative prediction horizons, rebalance frequencies, and transaction cost friction grids \citep{novy2016taxonomy, avramov2023machine}.
...
Figure \ref{fig:ch6_portfolio_flowchart} shows the decile portfolio sorting, 1-day execution buffer delay, and weight drift turnover rebalancing framework \citep{lopez2018advances, novy2016taxonomy}.
