...
print("Writing Massive 120+ Page Chapter Generator...")
...
save_file("literature_review.tex", ch2)
save_file("data_and_features.tex", ch3)
save_file("methodology.tex", ch4)
save_file("baseline_results.tex", ch5)
save_file("ml_and_backtesting.tex", ch6)
save_file("conclusion.tex", ch7)
